...
const CoreValueCard = React.memo(function CoreValueCard({
  ...
  return (
    ...
    >
      <IconComponent className="absolute -right-4 -bottom-4 h-28 w-28 text-white/10 transition-transform duration-500 group-hover:scale-110 group-hover:-rotate-6" />
      <div className="relative z-10 flex w-full flex-col items-center justify-center gap-1.5">
        ...
        >
          <IconComponent
            size={18}
            className={iconIsHeart ? "fill-current text-amber-500" : ""}
          />
        </div>
...
export function CoreValuesSection() {
  ...
  return (
    <div className="space-y-3" id="core-values-section">
