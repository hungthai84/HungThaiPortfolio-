...
export function PrinciplesSection() {
  ...
  return (
    <div
      className="rounded-[20px] border border-white/40 dark:border-white/10 bg-white/30 dark:bg-slate-900/60 backdrop-blur-[10px] p-5 sm:p-6 shadow-[0_2px_20px_rgba(0,0,0,0.1)] dark:shadow-[0_2px_20px_rgba(0,0,0,0.45)] flex flex-col justify-between h-full"
        ...
        {PILLARS_DATA.map((item) => {
          ...
          return (
            <div
              key={item.id}
              className={cn(
                "rounded-[16px] border p-3 sm:p-4 flex flex-col items-center justify-center text-center shadow-2xs transition-all duration-300 hover:shadow-md hover:-translate-y-0.5",
                item.gradientClass,
                item.borderClass
              )}
            >
