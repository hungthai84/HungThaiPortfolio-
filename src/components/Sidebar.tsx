...
export const allNavItemsList: NavItemConfig[] = [
  ...
  },
  {
    id: "about",
    icon: User,
    glassBg: "from-indigo-400/30 via-blue-400/25 to-purple-400/20 border-indigo-300/40",
    iconColor: "text-indigo-600 dark:text-indigo-400",
    hoverColor: "group-hover:text-indigo-600 dark:group-hover:text-indigo-400",
    activeBg: "from-indigo-500 via-blue-500 to-purple-500",
  ...
  },
  {
    id: "industries",
    icon: Building2,
    glassBg: "from-indigo-500/30 via-purple-500/25 to-blue-500/20 border-indigo-400/40",
    iconColor: "text-indigo-600 dark:text-indigo-400",
    hoverColor: "group-hover:text-indigo-600 dark:group-hover:text-indigo-400",
    activeBg: "from-indigo-600 via-purple-600 to-blue-600",
  ...
  },
  {
    id: "interview",
    icon: Video,
    glassBg: "from-purple-400/30 via-blue-400/25 to-indigo-400/20 border-purple-300/40",
    iconColor: "text-purple-600 dark:text-purple-400",
    hoverColor: "group-hover:text-purple-600 dark:group-hover:text-purple-400",
    activeBg: "from-purple-500 via-blue-500 to-indigo-500",
    activePill: "bg-purple-400 dark:bg-purple-300",
  },
  {
    id: "aiChat",
...
export function Sidebar({
  ...
  const filteredNavItems = allNavItemsList
    .filter((item) => item.id !== "wallpapers" && item.id !== "templateTest")
    .filter((item) => {
          ...
          {desktopNavItemsList.map((item) => {
            ...
            return (
              ...
              >
                ...
                {isActive && !isExpanded && (
                  <span className="absolute right-1 top-1/2 -translate-y-1/2 w-1.5 h-1.5 rounded-full bg-violet-500 shadow-[0_0_8px_rgba(139,92,246,0.8)]" />
                )}
              </motion.button>
            );
          })}
