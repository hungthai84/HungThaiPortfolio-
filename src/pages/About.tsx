    ...
    >
      <div className="w-full max-w-6xl mx-auto pb-8">
              ...
              {(() => {
                ...
                const allCards = [
                  // 1. VISUAL GREETING
                  {
                    ...
                    className: "rounded-2xl border border-white/20 bg-white/40 dark:bg-black/20 p-[10px] shadow-sm backdrop-blur-md"
                  },
                  // 2. PERSONAL PROFILE
                  {
                    id: "personal-profile",
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-1 gap-1.5">
                          {personalInfo.map((item, idx) => {
                            ...
                            return (
                              <div key={idx} className="flex items-center justify-between gap-2 p-2.5 rounded-xl border border-white/10 bg-white/40 dark:bg-black/20 transition-colors">
                    ...
                    className: "rounded-2xl border border-white/20 bg-white/40 dark:bg-black/20 p-5 shadow-sm backdrop-blur-md"
                  },
                  // 3. CX PHILOSOPHY
                  {
                    id: "cx-philosophy",
                    ...
                    className: "rounded-2xl border border-white/20 bg-white/40 dark:bg-black/20 p-6 shadow-sm backdrop-blur-md"
                  },
                  // 4. MISSION STATEMENT
                  {
                    ...
                    content: (
                      <div className="flex flex-col items-center text-center space-y-4">
                        ...
                        <div onClick={() => { playTactileSound("sparkle"); showToast(isVi ? "✨ Cam kết thấu cảm!" : "✨ Empathy commitment!"); }} className="relative cursor-pointer group w-full">
                          <div className="relative rounded-xl border border-rose-500/20 bg-gradient-to-r from-rose-500/5 to-amber-500/5 px-4 py-4 shadow-sm">
                    ...
                    className: "rounded-2xl border border-rose-500/20 bg-white/40 dark:bg-black/20 p-5 shadow-sm backdrop-blur-md"
                  },
                  // 5. IMPACT METRICS
                  {
                    id: "impact-metrics",
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          {quickMetrics.map((metric, idx) => (
                            <div key={idx} className="rounded-xl border border-white/10 bg-white/40 dark:bg-black/20 p-3 flex flex-col justify-center">
                        ...
                        <div className="flex flex-col gap-2">
                          {strategicPillars.map((pillar, idx) => {
                            ...
                            return (
                              <div
                                key={idx}
                                className={cn("group w-full rounded-xl p-4 transition-all relative duration-300 cursor-pointer border border-white/10 bg-white/20 dark:bg-black/20 overflow-hidden hover:translate-x-1", pillar.bg.replace("bg-", "bg-opacity-80 bg-"))}
        ...
        <motion.div
          ...
          className="rounded-3xl border border-white/20 bg-white/40 dark:bg-black/20 p-6 shadow-md flex flex-col lg:flex-row items-center justify-between gap-6 backdrop-blur-md"
        >
